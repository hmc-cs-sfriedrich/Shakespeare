...
export class AppComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		linesAct1Scene1.push(new Line("So have I heard and do in part believe it.", "Horatio", 11, 1));
		...
		linesAct1Scene2.push(new Line("Though yet of Hamlet our dear brother's death", "Claudius", 10, 1));
		...
		linesAct2Scene1.push(new Line("Marry, well said; very well said. Look you, sir,","Polonius", 11, 1));
